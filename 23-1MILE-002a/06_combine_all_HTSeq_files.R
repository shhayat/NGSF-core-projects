...
write.table(feature_count, '/globalhome/hxo752/HPC/ngsf_git_repos/NGSF-core-projects/23-1MILE-002a/analysis/htseq_counts/htseq_count.txt', sep="\t", row.names=FALSE, quote=FALSE)
