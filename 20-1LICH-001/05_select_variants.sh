...
bedtools flank -i ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_INFO}_base_conversion.bed -g /datastore/NGSF001/analysis/references/human/gencode-30/chrom.sizes -b 2 > ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_INFO}_flanked_2bp_upstream_downstream.bed
bedtools flank -i ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_INFO}_base_conversion.bed -g /datastore/NGSF001/analysis/references/human/gencode-30/chrom.sizes -b 2 > ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_INFO}_flanked_2bp_upstream_downstream.bed
...
bedtools getfasta -fi ${GENOME} -bed ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_INFO}_flanked_2bp_upstream_downstream.bed -tab > ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_INFO}_flanked_bases.txt
bedtools getfasta -fi ${GENOME} -bed ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_INFO}_flanked_2bp_upstream_downstream.bed -tab > ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_INFO}_flanked_bases.txt

echo "add each second line to first line"
awk '{printf "%s%s",$0,NR%2?"\t":RS}' ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_INFO}_flanked_bases.txt > ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_INFO}_flanked_bases_v1.txt
awk '{printf "%s%s",$0,NR%2?"\t":RS}' ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_INFO}_flanked_bases.txt > ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_INFO}_flanked_bases_v1.txt
...
paste --delimiters='\t' ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_INFO}_base_conversion.bed ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_INFO}_flanked_bases_v1.txt > ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_INFO}.txt

echo "join G to A/C conversions with their 2upstream and downtream base pairs"
paste --delimiters='\t' ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_INFO}_base_conversion.bed ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_INFO}_flanked_bases_v1.txt > ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_INFO}.txt
