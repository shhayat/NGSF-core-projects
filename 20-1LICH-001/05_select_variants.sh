...
/globalhome/hxo752/HPC/tools/bedops/convert2bed -i vcf < ${INPUT_DIR}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_concat.vcf -d >  ${INPUT_DIR}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_concat.bed
...
awk -v OFS='\t' '{print $1,$2,$3,$6,$7}' ${INPUT_DIR}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_concat.bed | grep -P '\tC\tG$' >> ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_base_conversion.bed
awk -v OFS='\t' '{print $1,$2,$3,$6,$7}' ${INPUT_DIR}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_concat.bed | grep -P '\tC\tT$' >> ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_base_conversion.bed
...
awk -v OFS='\t' '{print $1,$2,$3,$6,$7}' ${INPUT_DIR}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_concat.bed | grep -P '\tG\tA$' >> ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_base_conversion.bed
awk -v OFS='\t' '{print $1,$2,$3,$6,$7}' ${INPUT_DIR}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_concat.bed | grep -P '\tG\tC$' >> ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_base_conversion.bed

echo "select 2 bases upstream and downstream of bases"
#step3: select 2 bases upstream and downstream of bases in step2
bedtools flank -i ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_base_conversion.bed -g /datastore/NGSF001/analysis/references/human/gencode-30/chrom.sizes -b 2 > ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_flanked_2bp_upstream_downstream.bed
bedtools flank -i ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_base_conversion.bed -g /datastore/NGSF001/analysis/references/human/gencode-30/chrom.sizes -b 2 > ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_flanked_2bp_upstream_downstream.bed
...
bedtools getfasta -fi ${GENOME} -bed ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_flanked_2bp_upstream_downstream.bed -tab > ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_flanked_bases.txt
bedtools getfasta -fi ${GENOME} -bed ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_flanked_2bp_upstream_downstream.bed -tab > ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_flanked_bases.txt

echo "add each second line to first line"
awk '{printf "%s%s",$0,NR%2?"\t":RS}' ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_flanked_bases.txt > ${OUTPUT_DIR1}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_flanked_bases_v1.txt
awk '{printf "%s%s",$0,NR%2?"\t":RS}' ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_flanked_bases.txt > ${OUTPUT_DIR2}/${CLONE_ID}_${SAMPLE_ID}_${SAMPLE_INFO}_flanked_bases_v1.txt
