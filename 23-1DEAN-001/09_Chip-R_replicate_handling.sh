...
sort -k 8,8nr ${OUTDIR}/${cellLine}_optimal_filtered.bed > ${DIR}/${cellLine}_optimal_filtered_top.bed

#prep file for motif discovery
cut -f 1,2,3 ${OUTDIR}/${DIR}/${cellLine}_optimal_filtered_top.bed > ${OUTDIR}/${cellLine}_optimal_filtered_3_columns.bed 
