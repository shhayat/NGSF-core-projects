...
for 
  cat 230505_NB551711_0069_AHLJGJBGXM/R2300${i}*R1* 230511_NB551711_0072_AH5HTFBGXN/R2300${i}*R1* 230516_NB551711_0074_AHV2N3BGXN/R2300${i}*R1* 230510_NB551711_0071_AH5J3TBGXN/R2300${i}*R1* 230512_NB551711_0073_AHV2MWBGXN/R2300${i}*R1* > ${OUTDIR}/R2300${i}_R1.fastq.gz
  cat 230505_NB551711_0069_AHLJGJBGXM/R2300${i}*R2* 230511_NB551711_0072_AH5HTFBGXN/R2300${i}*R2* 230516_NB551711_0074_AHV2N3BGXN/R2300${i}*R2* 230510_NB551711_0071_AH5J3TBGXN/R2300${i}*R2* 230512_NB551711_0073_AHV2MWBGXN/R2300${i}*R2* > ${OUTDIR}/R2300${i}_R2.fastq.gz
