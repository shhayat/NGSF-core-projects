...
${annovar}/table_annovar.pl ${DIR}/D23000043_snps.avinput /globalhome/hxo752/HPC/tools/annovar/humandb/ -buildver hg38 -out ${DIR}/D23000043_annotation -remove -protocol ensGene41,gnomad_exome,exac03,avsnp147,1000g2015aug -operation g,f,f,f,f -nastring . -csvout -polish
${annovar}/table_annovar.pl ${DIR}/D23000044_snps.avinput /globalhome/hxo752/HPC/tools/annovar/humandb/ -buildver hg38 -out ${DIR}/23000044_annotation -remove -protocol ensGene41,gnomad_exome,exac03,avsnp147,1000g2015aug -operation g,f,f,f,f -nastring . -csvout -polish
