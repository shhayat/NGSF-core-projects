...
write.csv(pairwise_A3A_p3,"results/pairwise_A3A_wound_healing_signaling.csv", row.names = FALSE)
write.csv(pairwise_A3B_p3,"results/pairwise_A3B_wound_healing_signaling.csv", row.names = FALSE)
write.csv(pairwise_A3H_p3,"results/pairwise_A3H_wound_healing_signaling.csv", row.names = FALSE)
