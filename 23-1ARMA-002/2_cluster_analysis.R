...
SC2300019 <- load("seurat_object_SC2300019.RData")
SC2300020 <- load("seurat_object_SC2300020.RData")
SC2300021 <- load("seurat_object_SC2300021.RData")
SC2300022 <- load("seurat_object_SC2300022.RData")
