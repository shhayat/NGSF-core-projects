...
OUTDIR=/globalhome/hxo752/HPC/ngsf_git_repos/NGSF-core-projects/23-1MILE-002/analysis/fq_with_umi_header_v1
mkdir -p ${OUTDIR}
...
${umitools}/umi_tools extract -I ${fq1} \
                  -S ${OUTDIR}/${sample_name}_R1.fastq.gz \
                  --bc-pattern=NNNNNNNNNNN \
                  -log=${OUTDIR}/${sample_name}_R1.log
      
${umitools}/umi_tools extract -I ${fq1} \
                  -S ${OUTDIR}/${sample_name}_R2.fastq.gz \
                  --bc-pattern=NNNNNNNNNNN \
                  -log=${OUTDIR}/${sample_name}_R2.log
