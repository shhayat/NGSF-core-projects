...
GENOME=/NGSF001/analysis/references/human/iGenomes/Homo_sapiens/NCBI/GRCh38/Sequence/Bowtie2Index
...
./annotatePeaks.pl ERpeaks.txt ${GENOME} -gtf ${GTF} > ${OUTDIR}/{sample_name}_annotated_peaks.txt
