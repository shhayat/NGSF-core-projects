...
Rscript run_spp.R -i=${OUTDIR}/alignment/${sample_name}/${sample_name}.aligned_dedup.bam -savp=${OUTDIR}/QC/phantompeakqualtools/xcor_${sample_name}.pdf -out=${OUTDIR}/QC/phantompeakqualtools/xcor_metrics_${sample_name}.txt
