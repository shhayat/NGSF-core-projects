...
DEG_analysis(c(6,4),"A3A_U6","A3A_I5","A3A_U6",1,1)
#A3B_I5 vs A3B_U5 (n=2)
DEG_analysis(c(8,10),"A3B_U5","A3B_I5","A3B_U5",1,1)
#A3H_I4 vs A3H_U1 (n=2)
DEG_analysis(c(13,12),"A3H_U1","A3H_I4","A3H_U1",1,1)
#A3A_I4 vs A3A_U1 (n=2)
DEG_analysis(c(5,3),"A3A_U1","A3A_I4","A3A_U1",1,1)
#A3B_I2 vs A3B_U1 (n=2)
DEG_analysis(c(9,7),"A3B_U1","A3B_I2","A3B_U1",1,1)
#A3H_I1 vs A3H_U2 (n=2)
DEG_analysis(c(14,11),"A3H_U2","A3H_I1","A3H_U2",1,1)
