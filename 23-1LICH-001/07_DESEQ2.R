...
DEG_analysis <-  function(colnum,cond1, cond2, ref, rep_cond1,rep_cond2)
{
  ...
  write.xlsx(resDF,file=sprintf("DESEQ2/DEG_%s_vs_%s_increased.xlsx",cond2,cond1), row.names = FALSE)
}
...
DEG_analysis(c(13,12),"A3H_U1","A3H_I4","A3H_U1",2,2)
#A3A_I4 vs A3A_U1 (n=2)
DEG_analysis(c(5,3),"A3A_U1","A3A_I4","A3A_U1",2,2)
#A3B_I2 vs A3B_U1 (n=2)
DEG_analysis(c(9,7),"A3B_U1","A3B_I2","A3B_U1",2,2)
#A3H_I1 vs A3H_U2 (n=2)
DEG_analysis(c(14,11),"A3H_U2","A3H_I1","A3H_U2",2,2)
