...
#A3B U2 (1)(2)
cat ${OUTDIR1}/R2300147_R1.fastq.gz ${OUTDIR}/R2300147_R1.fastq.gz > ${OUTDIR2}/A3B_U2_R1.fastq.gz
cat ${OUTDIR1}/R2300147_R2.fastq.gz ${OUTDIR}/R2300147_R2.fastq.gz > ${OUTDIR2}/A3B_U2_R2.fastq.gz
...
#A3H I4
cat ${FASTQ_FOLDER2}/R2300137_R1.fastq.gz ${OUTDIR1}/R2300157_R1.fastq.gz > ${OUTDIR2}/A3H_I4_R1.fastq.gz
cat ${FASTQ_FOLDER2}/R2300137_R1.fastq.gz ${OUTDIR1}/R2300157_R2.fastq.gz > ${OUTDIR2}/A3H_I4_R2.fastq.gz
#A3H U2 (1)(2)
