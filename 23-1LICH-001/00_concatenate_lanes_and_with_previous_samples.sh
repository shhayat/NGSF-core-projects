...
#for i in $(seq -w 143 147) $(seq -w 149 154) $(seq -w 156 160) $(seq -w 167 168)
#do
...
#A3A U6
#cat ${FASTQ_FOLDER2}/R2200132_R1.fastq.gz ${OUTDIR1}/R2300143_R1.fastq.gz > ${OUTDIR2}/A3A_U6_R1.fastq.gz
#cat ${FASTQ_FOLDER2}/R2200132_R2.fastq.gz ${OUTDIR1}/R2300143_R2.fastq.gz > ${OUTDIR2}/A3A_U6_R2.fastq.gz
#A3A I5
#cat ${FASTQ_FOLDER2}/R2200133_R1.fastq.gz ${OUTDIR1}/R2300144_R1.fastq.gz > ${OUTDIR2}/A3A_I5_R1.fastq.gz
#cat ${FASTQ_FOLDER2}/R2200133_R2.fastq.gz ${OUTDIR1}/R2300144_R2.fastq.gz > ${OUTDIR2}/A3A_I5_R2.fastq.gz
#A3A I4 (1)(2)
...
#A3B I2 (1)(2)
cat ${OUTDIR1}/R2300154_R1.fastq.gz ${OUTDIR1}/R2300156_R1.fastq.gz > ${OUTDIR2}/A3B_I2_R1.fastq.gz
cat ${OUTDIR1}/R2300154_R2.fastq.gz ${OUTDIR1}/R2300156_R2.fastq.gz > ${OUTDIR2}/A3B_I2_R2.fastq.gz


#A3H U1
#cat ${FASTQ_FOLDER2}/R2200136_R1.fastq.gz ${OUTDIR1}/R2300147_R1.fastq.gz > ${OUTDIR2}/A3H_U1_R1.fastq.gz
#cat ${FASTQ_FOLDER2}/R2200136_R2.fastq.gz ${OUTDIR1}/R2300147_R2.fastq.gz > ${OUTDIR2}/A3H_U1_R2.fastq.gz
#A3H U2 (1)(2)
#cat ${OUTDIR1}/R2300157_R1.fastq.gz ${OUTDIR1}/R2300159_R1.fastq.gz > ${OUTDIR2}/A3H_U2_R1.fastq.gz
cat ${OUTDIR1}/R2300157_R2.fastq.gz ${OUTDIR1}/R2300159_R2.fastq.gz > ${OUTDIR2}/A3H_U2_R2.fastq.gz
#A3H I4
