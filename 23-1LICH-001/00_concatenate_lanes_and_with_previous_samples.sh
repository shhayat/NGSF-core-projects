...
#A3A I4 (2)
cat ${OUTDIR}/R2300152_R1.fastq.gz
cat ${OUTDIR}/R2300152_R2.fastq.gz
#A3A U4 (1)
cat ${OUTDIR}/R2300149_R1.fastq.gz
cat ${OUTDIR}/R2300149_R2.fastq.gz
#A3A U1 (2)
...
#A3B U1 (2)
cat ${OUTDIR}/R2300168_R1.fastq.gz
cat ${OUTDIR}/R2300168_R2.fastq.gz
#A3B U2 (1)
