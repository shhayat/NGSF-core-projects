...
do
  ...
  mkdir -p $OUTDIR
  echo "wget https://ftp.sra.ebi.ac.uk/vol1/fastq/SRR993/00${NUM}/SRR9936${i}/SRR9936${i}_1.fastq.gz" >> $OUTDIR/path_to_fastq_files.sh
  echo "wget https://ftp.sra.ebi.ac.uk/vol1/fastq/SRR993/00${NUM}/SRR9936${i}/SRR9936${i}_2.fastq.gz" >> $OUTDIR/path_to_fastq_files.sh
done
