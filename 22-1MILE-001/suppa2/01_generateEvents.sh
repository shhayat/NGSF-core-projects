...
GTF=/datastore/NGSF001/analysis/references/mouse/mm10/mm10.refGene.gtf
OUTDIR=/globalhome/hxo752/HPC/ngsf_git_repos/NGSF-core-projects/22-1MILE-001/suppa2/suppa2_analysis/events

mkdir -p ${OUTDIR}
${SUPPA}/python ${SUPPA}/suppa.py generateEvents -i ${GTF} -o ${OUTDIR}/events_from_gtf -f ioe -e SE SS MX RI FL  
